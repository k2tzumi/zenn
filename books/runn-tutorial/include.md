---
title: "既存のシナリオから新しいシナリオを作成する"
free: true
---

# 既存のシナリオから新しいシナリオを作成する

[前のチャプタ](https://zenn.dev/katzumi/books/runn-tutorial/viewer/loop) でスステップを繰り返し実行できるようになりました。 
...
こちらのシナリオの内容は ["ステップに名前を付ける"](https://zenn.dev/katzumi/books/runn-tutorial/viewer/ordered-map#mapにする) の内容とまったく同じです。
...
bind の使い方については ["任意の値に別名をつける"](https://zenn.dev/katzumi/books/runn-tutorial/viewer/bind) をご参照ください。
