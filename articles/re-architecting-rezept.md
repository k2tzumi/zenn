...
幸いのことにLITALICOグループ内で、請求データを効率よく作る為のデータ構造のノウハウと実績があった為、そちらをベースに各プラットフォームの要件のニーズに合わせてアレンジしてAPIとして実装しました。APIがドメイン知識を集約して体現するものになります。今後の法改正時にも向き合っていくことになるので慎重に設計をする様に心がけました。
...
https://qiita.com/t-konta/private/4071cf36eb2c38d6f76e
...
どの取り組みも課題を可決する為の一つのアイデアですが、背景を再整理してより良いアイデアが生まれたらと思い記事にしました。  
