...
それでも1回目の 2021 年でのリアーキテクチャでは、余分な関心ごとが混ざっており切り離すには苦労をしました。
...
これらの各種実績データをかき集めてきて請求計算を行うのですが、これを1つのインターフェースとしてまとめていくわけです。
...
障害福祉領域で法制度という1つのドメインに見えるかも知れませんが、告示内容に記載している内容を細かく見ていくと
